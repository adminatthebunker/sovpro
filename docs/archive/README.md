...
Historical documents kept for reference. Decisions from these files have been folded into the live docs (`CLAUDE.md`, `docs/timeline.md`, current plan docs); the originals are preserved here so the reasoning trail isn't lost.

Nothing in this directory is authoritative. If you find yourself relying on something here, the live doc that supersedes it is the right place to make a change.
