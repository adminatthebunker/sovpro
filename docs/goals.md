...
- **Embed stack:** HuggingFace TEI serving Qwen3-Embedding-0.6B on RTX 4050 Mobile at fp16. Migrated off BGE-M3 on 2026-04-19 after the three-way eval in `docs/archive/embedding-eval-2026-04.md` picked Qwen3-0.6B (+13% NDCG@10, +9% Recall@20, ~1.6× throughput) with an acceptable cross-lingual regression.
